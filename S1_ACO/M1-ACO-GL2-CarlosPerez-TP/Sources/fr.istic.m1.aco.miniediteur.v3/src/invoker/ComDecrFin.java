...
/**
 * Represents the command that decreases the selection cursor one position. Demands the engine to perform
 * the correct operations in order to decrease the position of the selection cursor in the buffer.    
 * @author Carlos Perez carlosinftech
 * @since 2015-11-20
 */
public class ComDecrFin implements Command, IOriginator {
	/**
	 ...
	 */
	public ComDecrFin(MoteurEditeur moteurImpl, Caretaker caretaker) {
