...
public class CommandLauncher extends JFrame implements ICommandLauncher
{
	...
	public CommandLauncher(Map <String , Command> commands) {
		...
		ComDefaire icommand2=(ComDefaire) commands.get("defaire");
		icommand.setIHM(this);
		commands.put("defaire",icommand2);
		ComRefaire icommand3=(ComRefaire) commands.get("refaire");
		icommand.setIHM(this);
		commands.put("refaire",icommand3);
	   ...
	   JButton btnInsert = new JButton("insérer");
		...
		JButton btnDefaire = new JButton("defaire");
		btnDefaire.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				commands.get("defaire").execute();
			}
		});
