...
/**
 * Represents the command that increases the insertion cursor one position. Demands the engine to perform
 * the correct operations in order to increase the position of the insert cursor in the buffer.    
 * @author Carlos Perez carlosinftech
 * @since 2015-11-20
 */
public class ComIncrDebut implements Command, IOriginator {
	/**
	 ...
	 */
	public ComIncrDebut(MoteurEditeur moteurImpl, Caretaker caretaker) {
