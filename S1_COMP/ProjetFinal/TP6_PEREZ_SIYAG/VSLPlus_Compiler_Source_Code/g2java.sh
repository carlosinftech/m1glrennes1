...
ANTLR_JAR=/home/stupidon/Documents/ISTIC/M1/COMP/DM/antlr-3.5.2-complete.jar
if [ ! -r $ANTLR_JAR ]
then
...
export CLASSPATH=/home/stupidon/Documents/ISTIC/M1/COMP/DM/antlr-3.5.2-complete.jar:.:$CLASSPATH
